...
type BookingRequestSearchParams struct {
	UserID        int
	SearchText    string
	SortColumn    string
...
type BookingRequestWithDetails struct {
...
type PaginatedBookingRequests struct {
	BookingRequests []BookingRequestWithDetails `json:"bookingRequests"`
